...
class AngularLsh {
   public:
     ...
     * @param numBands
     */
    AngularLsh(size_t vectorLen, size_t numHashPerBand, size_t numBands);
     ...
     * @return double
     */
    static double angular(const std::vector<double> &vec1,
     ...
     * @return double
     */
    static double angular(const SparseVector &vec1, const SparseVector &vec2);
